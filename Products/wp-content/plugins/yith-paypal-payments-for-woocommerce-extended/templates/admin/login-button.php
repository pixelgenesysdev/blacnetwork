			...
			<?php if ( ! $merchant->is_valid() ) : ?>
				<div class="yith-ppwc-button-wrapper">
					<a href="<?php echo esc_url( $login_url ); ?>" target="_blank"
							data-paypal-onboard-complete="onboardedCallback" data-paypal-button="PPLtBlue" class="button button-primary" data-locale="pt_BR" data-yith-paypal-onboard-button="true">
