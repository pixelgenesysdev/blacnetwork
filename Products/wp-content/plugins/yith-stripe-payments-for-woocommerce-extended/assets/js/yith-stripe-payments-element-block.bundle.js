...
;// ./assets/js/src/modules/PaymentElementBlock.js
...
function PaymentElementBlock_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, PaymentElementBlock_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function PaymentElementBlock_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (PaymentElementBlock_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
...
var PaymentElementBlock = /*#__PURE__*/function (_PaymentElementChecko) {
  ...
  function PaymentElementBlock() {
    ...
    _this = PaymentElementBlock_callSuper(this, PaymentElementBlock);
    /**
     * Reference to node that works as elements wrapper
     */
    defineProperty_defineProperty(_this, "nodeRef", void 0);
    /**
     * Billing details
     */
    defineProperty_defineProperty(_this, "billing", void 0);
    _this.unmount = _this.unmount.bind(_this);
    _this.onPaymentProcessing = _this.onPaymentProcessing.bind(_this);
    return _this;
  }
  ...
  return _createClass(PaymentElementBlock, [{
    key: "init",
    value: function init() {
      this.registerMethod();
      this.initStripe();
    ...
    value: function unmount() {
      ...
      (_this$paymentElement = this.paymentElement) === null || _this$paymentElement === void 0 || _this$paymentElement.unmount();
    }
...
;// ./assets/js/src/element-block.js
