...
defined( 'YITH_STRIPE_PAYMENTS_VERSION' ) || define( 'YITH_STRIPE_PAYMENTS_VERSION', '1.0.8' );
...
if ( ! function_exists( 'yith_stripe_payments_constructor' ) ) {
	...
	function yith_stripe_payments_constructor() {
		load_plugin_textdomain( 'yith-stripe-payments-for-woocommerce', false, plugin_basename( YITH_STRIPE_PAYMENTS_LANG ) );
...
if ( ! function_exists( 'yith_stripe_payments_maybe_load_plugin_fw' ) ) {
	...
	function yith_stripe_payments_maybe_load_plugin_fw() {
		if ( ! function_exists( 'yit_maybe_plugin_fw_loader' ) && file_exists( YITH_STRIPE_PAYMENTS_DIR . 'plugin-fw/init.php' ) ) {
			require_once YITH_STRIPE_PAYMENTS_DIR . 'plugin-fw/init.php';
		}

		yit_maybe_plugin_fw_loader( YITH_STRIPE_PAYMENTS_DIR );
